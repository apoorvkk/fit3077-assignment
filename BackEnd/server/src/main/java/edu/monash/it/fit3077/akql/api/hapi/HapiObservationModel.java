...
public class HapiObservationModel {
    ...
    /**
     * Instantiates the health measurement presentation model.
     * @param resource: HAPI's health measurement.
     */
    ...
    /**
     * Gets the id of the health measurement from the HAPI health measurement.
     * @return the id of the health measurement.
     */
    public String getId() {
